...
char text1[] = { "BNM Institute of Technology" };
...
char text9[] = { "Afshan Tabassum" };
char text10[] = { "1BG20CS006" };
char text11[] = { "Anusha A" };
char text12[] = { "1BG20CS017" };
char text13[] = { "Teacher Incharge:Prof. Akshatha " };
//char text14[] = { "Prof. Akshatha" };
